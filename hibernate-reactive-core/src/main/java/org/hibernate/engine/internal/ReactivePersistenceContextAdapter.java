...
public class ReactivePersistenceContextAdapter implements PersistenceContext {
	...
	@Override
	public PersistentCollection<?> useUnownedCollection(
			CollectionKey key) {
	...
	@Override
	public EntityEntry removeEntry(
			Object entity) {
	...
	public PersistentCollection<?> getCollectionHolder(
			Object array) {
	...
	@Incubating
	@Override
	public EntityHolder addEntityHolder(
			EntityKey key,
			Object entity) {
	...
	@Override
	public EntityHolder removeEntityHolder(
			EntityKey key) {
	...
	@Internal
	@Override
	public void replaceEntityEntryRowId(
			Object entity,
			Object rowId) {
	...
	@Override
	public void registerInsertedKey(
			EntityPersister persister,
			Object id) {
	...
	@Override
	public CollectionEntry removeCollectionEntry(
			PersistentCollection<?> collection) {
