...
public class MutinySessionFactoryImpl implements Mutiny.SessionFactory, Implementor {
	...
	@Override
	public Mutiny.Session openSessionWithLazyConnection() {
		return openSessionWithLazyConnection( getTenantIdentifier( options() ) );
	}

	@Override
	public Mutiny.Session openSessionWithLazyConnection(String tenantId) {
	...
	@Override
	public Mutiny.StatelessSession openStatelessSessionWithLazyConnection() {
		return openStatelessSessionWithLazyConnection( getTenantIdentifier( options() ) );
	}

	@Override
	public Mutiny.StatelessSession openStatelessSessionWithLazyConnection(String tenantId) {
		final SessionCreationOptions options = options();
		ReactiveConnectionPool pool = delegate.getServiceRegistry().getService( ReactiveConnectionPool.class );
