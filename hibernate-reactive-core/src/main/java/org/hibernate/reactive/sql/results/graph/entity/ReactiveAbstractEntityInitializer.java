...
public abstract class ReactiveAbstractEntityInitializer extends AbstractEntityInitializer {
	...
	public void initializeInstance(RowProcessingState rowProcessingState) {
		throw LOG.nonReactiveMethodCall( "rowProcessingState" );
	}
	...
	public CompletionStage<Void> reactiveInitializeInstance(ReactiveRowProcessingState rowProcessingState) {
		...
		return voidFuture()
				.thenCompose( v -> lazyInitializer != null
						? lazyInitialize( rowProcessingState, lazyInitializer )
						: initializeEntity( getEntityInstance(), rowProcessingState )
	...
	private CompletionStage<Void> lazyInitialize(
		...
		if ( instance == null ) {
			return createInstance( rowProcessingState, lazyInitializer, persistenceContext );
		}
	...
	private CompletionStage<Void> createInstance(
			ReactiveRowProcessingState rowProcessingState,
			LazyInitializer lazyInitializer,
