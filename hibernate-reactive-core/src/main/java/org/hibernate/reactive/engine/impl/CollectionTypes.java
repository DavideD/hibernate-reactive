...
public abstract class CollectionTypes {
	...
	public static CompletionStage<Object> replace(
		...
		return needsReplacement( type, foreignKeyDirection )
	...
	public static CompletionStage<Object> replaceElements(
			CollectionType type,
			Object original,
			Object target,
			Object owner,
	...
	private static Object instantiateResultIfNecessary(CollectionType type, Object original, Object target) {
		...
		return target == null
				...
				? instantiateResult( type )
				: target;
	}

	private static Object instantiateResult(CollectionType type) {
		// by default just use an unanticipated capacity since we don't
		// know how to extract the capacity to use from original here...
		return type.instantiate( -1 );
	}

	private static boolean needsReplacement(CollectionType type, ForeignKeyDirection foreignKeyDirection) {
