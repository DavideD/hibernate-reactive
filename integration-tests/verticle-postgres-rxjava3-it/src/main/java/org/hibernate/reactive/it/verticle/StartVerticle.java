...
//				.addService( VertxInstance.class, (VertxInstance) () -> vertx )
	...
	private static void startHibernate(Promise<Stage.SessionFactory> promise) {
		try {
			final Stage.SessionFactory sessionFactory = createHibernateSessionFactory( true, null )
	...
	public static void main(String[] args) {
		...
		vertx
				.executeBlocking( StartVerticle::startHibernate )
				.concatMap( sf -> vertx.deployVerticle( () -> new ProductVerticle( () -> sf ), options ).toMaybe() )
				.subscribe( d -> {
