...
public class StartVerticle {
	...
	public static SessionFactory createHibernateSessionFactory(boolean enableDocker) {
	...
	public static void main(String[] args) {
		final Mutiny.SessionFactory sessionFactory = createHibernateSessionFactory( true )
