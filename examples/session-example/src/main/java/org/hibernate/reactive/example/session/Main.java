...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// TODO:  getting Compiler Errors
			//      Work on setting up criteria correctly
//			factory.withSession(
...
//						Join<Author, Book> b = a.join( Author.getBooks() );
...
//					session -> session.find( Book.class, book1.getId() )
//							// fetch a lazy field of the Book
//							.thenCompose( book -> session.fetch( book, book1.getPublished() )
//									// print the lazy field
